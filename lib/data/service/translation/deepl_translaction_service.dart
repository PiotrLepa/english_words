...
import 'package:english_words/data/model/translations/translations_response.dart';
...
class DeeplTranslationService implements TranslationService {
  ...
  @override
  Future<List<TranslationResponse>> translate(String text) async {
    final uri = Uri.https(
      _authority,
      _path,
      {
    ...
    return http.post(uri, headers: _headers).then((response) {
      if (response.statusCode == HttpStatus.ok) {
        ...
        return TranslationsResponse.fromJson(json).translations;
      } else {
        return Future.error(
