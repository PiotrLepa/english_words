...
import 'package:english_words/domain/use_case/get_text_definitions_use_case.dart';
...
class GetInfoAndSaveTextUseCase {
  ...
  final GetTextDefinitionsUseCase _getTextDefinitionsUseCase;
  ...
  Future<SavedText> invoke(String text) {
    return Future.wait([
      ...
      final definitions = data[2] as List<WordDefinitions>;
      return SavedText(
        id: null,
        originalText: text,
